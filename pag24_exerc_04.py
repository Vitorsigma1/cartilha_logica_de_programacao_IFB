...
quarto_numero = float(input("Digite novamento um número: "))
somar = primeiro_numero + segundo_numero + terceiro_numero + quarto_numero
media = somar / 4
print(f"O resultado da média dos quatro número é: {media:.2f}")
